...
@interface JSSCollectViewController ()
...
@implementation JSSCollectViewController
...
- (void)loadMoreDeals
{
    ...
    NSArray *newDeals = [JSSDealTool currentCollectWithPage:self.currentPage];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section
{
    ...
    [self.collectionView setFooterHidden:self.deals.count == [JSSDealTool countOfCurrentDeals]];
